...
app_description = "Doctor Appointment Booking System"
app_email = "booking@yahoo.com"
app_license = "mit"
...
add_to_apps_screen = [
	{
		"name": "booking",
		"logo": "/assets/booking/frontend/favicon.svg",
		"title": "Booking",
		"route": "/booking",
	}
]
...
# Note: The booking frontend now uses Vite for building (see apps/booking/frontend)
# web_include_css = "/assets/booking/frontend/booking.css"
# web_include_js = "/assets/booking/frontend/booking.bundle.js"
...
website_route_rules = [
	{"from_route": "/booking/<path:app_path>", "to_route": "_booking"},
	{"from_route": "/booking", "to_route": "_booking"},
]

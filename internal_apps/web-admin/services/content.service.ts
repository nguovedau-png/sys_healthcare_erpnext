...
class ContentService {
    ...
    async getPosts(params?: any): Promise<PaginatedResponse<Post>> {
    ...
    async pushPostToBots(id: string | number, platforms: string[]): Promise<any> {
        return apiService.post(`/content/posts/${id}/push`, { platforms });
    }
    ...
    async getBanner(id: string | number): Promise<Banner> {
        return apiService.get(`/content/banners/${id}`);
    }
    ...
    async updateBanner(id: string | number, data: any): Promise<Banner> {
        return apiService.put(`/content/banners/${id}`, data);
    }
    ...
    async getVideo(id: string | number): Promise<Video> {
        return apiService.get(`/content/videos/${id}`);
    }
    ...
    async updateVideo(id: string | number, data: any): Promise<Video> {
        return apiService.put(`/content/videos/${id}`, data);
    }
    ...
    async getQuestions(): Promise<Question[]> {
        return apiService.get('/content/questions');
    }
    ...
    async getTopics(): Promise<Topic[]> {
        return apiService.get('/content/topics');
    }
    ...
    async getComments(targetId: string, targetType: 'post' | 'question' | 'video'): Promise<Comment[]> {
        return apiService.get('/content/comments', { params: { targetId, targetType } });
    }

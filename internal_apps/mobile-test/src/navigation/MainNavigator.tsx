...
import { Home, User, Briefcase, Building2, MessageCircle, Settings, Bell, BookOpen } from 'lucide-react-native';
...
// LMS Screens
import LMSHomeScreen from '../modules/lms/screens/LMSHomeScreen';
import CourseDetailScreen from '../modules/lms/screens/CourseDetailScreen';
import LessonScreen from '../modules/lms/screens/LessonScreen';
...
const LMSStack = () => (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="LMSHome" component={LMSHomeScreen} />
...
const MainNavigator = () => {
    ...
    return (
        <Tab.Navigator
            screenOptions={{
                tabBarActiveTintColor: '#0ea5e9', // primary500 equivalent in Tailwind/Gluestack colors
                tabBarInactiveTintColor: '#64748b', // textDark400
                tabBarStyle: {
                    backgroundColor: '#0f172a', // backgroundDark950
                    borderTopColor: '#1e293b', // borderDark800
                    borderTopWidth: 1,
                    paddingBottom: 5,
                    height: 60,
                },

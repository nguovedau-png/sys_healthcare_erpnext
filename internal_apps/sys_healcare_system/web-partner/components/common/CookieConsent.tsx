    ...
    return (
        <div className="fixed bottom-0 left-0 w-full bg-gray-900 text-white p-4 shadow-lg z-50 flex flex-col sm:flex-row justify-between items-center gap-4 animate-slide-up">
            ...
            <div className="flex gap-3">
                <Button ghost size="small" onClick={() => setVisible(false)}>Từ chối</Button>
                <Button type="primary" size="small" onClick={handleAccept} className="bg-blue-600 hover:bg-blue-500 border-none">
                    Chấp nhận tất cả
                </Button>
            </div>
        </div>

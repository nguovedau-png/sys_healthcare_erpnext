...
const Banner: React.FC<BannerProps> = ({ page }) => {
  ...
  const getDisplayConfig = (): DisplayClass => {
    const baseSearch = {
      ...
      city: 'w-full sm:w-auto shrink-0' as string | boolean,
      btn: 'shrink-0'
    };
      ...
      case 'search':
        return {
          ...
          search: {
            ...
            wrap: 'w-full',
            keyword: 'flex-1 min-w-0',
            type: 'w-full sm:w-auto shrink-0',
            district: 'w-full sm:w-auto shrink-0',
            city: 'w-full sm:w-auto shrink-0',
            btn: 'shrink-0'
          },
          tagList: false,
          advanced: true
  ...
  return (
    ...
    <div className={classNames(
        title
          ? 'absolute w-full h-full flex items-center overflow-x-hidden py-[40px] md:py-0'
          : 'relative w-full flex items-center overflow-x-hidden py-10 sm:py-14'
      )}>
                ...
                <div className={classNames("mt-0 lg:mt-[20px]", { "mt-[20px]": advanced })}>
                  <div className="flex flex-wrap items-stretch gap-2">
                    ...
                    <div className={classNames(search.btn)}>
                      <button className="bg-[#47af50] text-white h-[48px] px-6 rounded-[5px] w-full text-[17px] font-medium hover:bg-[#3d9744] transition-colors shadow-md whitespace-nowrap" type="submit">Tìm kiếm</button>
                    </div>
                  </div>
                </div>
